...
bpm = 'bpm'
pumpoutID = 'pumpoutID'
premiumModeExclusive = 'premiumModeExclusive'
steamLinkExclusive = 'steamLinkExclusive'
sortingID = 'sortingID'
shortTitle = 'shortTitle'
arcadeName = 'arcadeName'
altID = 'altID'
arcadeID = 'arcadeID'
arcadeNameMaxEditDistance = 'arcadeNameMaxEditDistance'
duration = 'duration'
region = 'region'
fromMix = 'fromMix'
changes = 'changes'
...
STEPMAKERS = {
	"Utopia": [("SUNNY", 'S20 D22')],
	"Rolling Christmas": [("JUNARE", 'S20')],
	"Dr. M": [("BPM", 'D20')],
	"Vacuum": [("DulKi", 'S16 D16')],
	"Unique": [("DIESEL", 'D22')],
	"Point Break": [("CONRAD", 'D23')],
	"HELIX": [("refos", 'D23')],
	"Cosmical Rhythm": [("SUNNY", 'S17')],
	"Awakening": [("refos", 'S22 D24')],
	"Iolite Sky": [("DulKi", 'D20')],
	"Pump Me Amadeus": [("SUNNY", 'S16')],
	"Moonlight":  [("EXC", 'D24')],
	...
	"BANG BANG": "CONRAD",
	"404 (New Era)": "NIMGO",
	"Enjoy The Show": "NIMGO",
	"Punishment Restaurant": "JUNARE",
	"BLAZOR": "GGWANG",
	"B3": "CONRAD",
	"Digitalis": "SPHAM",
	"The Last Rebellion": "GGWANG",
	"OVERNIGHT FLOWER": "CONRAD",
	"Legendary Dominion": "EXC",
	"Crash-Landing Rendezvous": "FEFEMZ",
	"QUATTUORUX": "FEFEMZ",
	"NightTheater": "FEFEMZ",
	"INFiNiTE ENERZY -Overdoze-": "refos",
	"Freedom Dive": "EXC",
	"Dreamchasers": "GGWANG",
	"SUPER☆HARAGURO☆POP": "refos",
	"Cynical": "CONRAD",
	"Rise Up": "CONRAD",
	"Ercitite": "FEFEMZ",
	"King’s Tomb": "refos",
	"Dizzy Dance, Street Light": "NIMGO",
	"Unfelicitas": "SUNNY",
	"Pull me up": "SUNNY",
	"Antique Serenade": "GGWANG",
	"We Love Your Step": "refos",
	"Lucky Star": "CONRAD",
}
...
KOREAN_TITLES = {
	...
	"Lacrimosa": "라크리모사",
	"Galaxy Collapse": "갤럭시 컬랩스",
	"WHISPER": "위스퍼",
	"Euphorianic  [SHORT]": "유포리아닉",
	"Halloween Party ~Multiverse~": "할로윈 파티",

	"ELEVEN": "일레븐",
    "Neo Catharsis": "네오 카타르시스",
	...
	"BANG BANG": "뱅 뱅",
	"404 (New Era)": "뉴 에라",
	"Enjoy The Show": "엔조이 더 쇼",
	"Punishment Restaurant": "응징 레스토랑",
	"BLAZOR": "블레이저",
	"B3": "B3",
	"Digitalis": "디기탈리스",
	"The Last Rebellion": "더 라스트 리벨리온",
	"OVERNIGHT FLOWER": "오버나이트 플라워",
	"Legendary Dominion": "레전더리 도미니언",
	"Crash-Landing Rendezvous": "크래쉬 랜딩 랑데부",
	"QUATTUORUX": "콰투오룩스",
	"NightTheater": "나이트시어터",
	"INFiNiTE ENERZY -Overdoze-": "인피니트 에너지 -Overdoze-",
	"Freedom Dive": "프리덤 다이브",
	"Dreamchasers": "드림체이서즈",
	"SUPER☆HARAGURO☆POP": "슈퍼☆하라구로☆팝",
	"Cynical": "시니컬",
	"Rise Up": "라이즈 업 (feat. Miori Celesta)",
	"Ercitite": "에르시타이트",
	"King’s Tomb": "왕의 무덤",
	"Dizzy Dance, Street Light": "취낙원무",
	"Unfelicitas": "불행의 여신",
	"Pull me up": "풀 미 업 (Feat. Monya)",
...
"18__INFiNiTE_ENERZY_Overdoze_":
{
	title: "INFiNiTE ENERZY -Overdoze-", artist: "Reku Mochizuki", channel: WORLD, bpm: "180",
...
{
	title: "Euphorianic  [SHORT]", artist: "SHK", channel: ORIGINAL, bpm: "140", duration: SHORT,
